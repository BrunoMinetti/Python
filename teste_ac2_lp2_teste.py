...
#
# e-mail: bruno_sanches@aluno.faculdadeimpacta.com.br
...
class Cobra(Reptil):
    ...
    def rastejar(self):
        return '{} ratejando'.format(self.nome)
    
    def trocar_pele(self):
        return '{} trocando de pelo'.format(self.nome)
...
class Jacare(Reptil):
    ...
    def atacar(self):
        return '{} atancando'.format(self.nome)
...
Instanciamento:
"""
cat = Gato('Fofo', 'amarelo', 5, '4 patas', 7)
jaca = Jacare('Wally','verde',30,220)
camarada = Camaleao('Pit','idefinida',15,'mosca')
snake = Cobra('Gertrudes','azul',1,'inofensivo')
dog = Cachorro('Ruffos','braco',1,'4 patas','pastor alemao')
horse = Cavalo('Fluff','marrom',5,'4 patas','negra')
